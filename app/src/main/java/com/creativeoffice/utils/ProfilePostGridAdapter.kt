...
class ProfilePostGridAdapter(var myContext: Context, var kullaniciPostlari: ArrayList<UserPost>) : RecyclerView.Adapter<ProfilePostGridAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        UniversalImageLoader.setImage(dosyaYolu!!, holder.imgTekSutun, holder.progressBar)
        ...
        if (dosyaTuru != null) {
            ...
            if (dosyaTuru.equals(".mp4")) {
                ...
                UniversalImageLoader.setImage("file:/" + kullaniciPostlari.get(position), holder.imgTekSutun, holder.progressBar)
            } else {
                holder.videoSure.visibility = View.GONE
